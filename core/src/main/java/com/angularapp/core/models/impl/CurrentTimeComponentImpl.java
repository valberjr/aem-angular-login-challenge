...
import com.angularapp.core.models.CurrentTimeComponent;
...
@Model(adaptables = {
    ...
    CurrentTimeComponent.class,
    ComponentExporter.class
}, resourceType = "angularapp/components/current-time-component")
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME, extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class CurrentTimeComponentImpl
    implements CurrentTimeComponent
{
