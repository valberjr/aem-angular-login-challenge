...
/**
 * Defines the {@code CurrentTimeComponent} Sling Model used for the {@code angularapp/components/current-time-component} component.
 * 
 */
@ConsumerType
public interface CurrentTimeComponent
